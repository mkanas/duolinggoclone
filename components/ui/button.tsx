  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold uppercase tracking-wide ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        primaryOutline: "bg-white text-sky-500 hover:border-slate-100 ",
        secondary:
          "bg-green-400 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-green-500 hover:border-slate-100",
        danger:
          "bg-rose-400 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:border-slate-100",
        super:
          "bg-indigo-400 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border-b-0",
        superOutline: "bg-white text-indigo-500 hover:border-slate-100",
        ghost:
          "bg-transparent text-slate-500 border-transparent border-s0 hover:border-slate-100",
        sidebar:
          "bg-transparent text-slate-500 border-transparent border-s0 hover:border-slate-100 transition-none",
        sidebarOutline:
          "bg-sky-500/15  text-sky-500 border-sky-300 border-2 hover:border-sky-500/20 transition-none",
      },
      size: {
